//----------------------------------------------------------------------------
// name: JoshGoHome_2Tokyo2Drift.cpp
// desc: sequence this.
//
...
int main( int argc, const char ** argv )
{
    ...
    {
        // error message
        cerr << "[2Tokyo2Drift]: cannot initialize real-time audio I/O..." << endl;
        return -1;
    }
    ...
    {
        // error message
        cerr << "[2Tokyo2Drift]: cannot initialize graphics/data system..." << endl;
        return -1;
    }
    ...
    {
        // error message
        cerr << "[2Tokyo2Drift]: cannot start real-time audio I/O..." << endl;
        return -1;
    }
